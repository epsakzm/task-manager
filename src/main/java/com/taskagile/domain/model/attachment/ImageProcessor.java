...
public class ImageProcessor {
    ...
    public void resize(String sourceFilePath, String targetFilePath, Size resizeTo) throws IOException, InterruptedException, IM4JavaException {
        Assert.isTrue(resizeTo.getHeight() > 0);
        Assert.isTrue(resizeTo.getWidth() > 0);
